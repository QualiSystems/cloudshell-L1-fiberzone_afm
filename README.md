# FiberZone_AFM L1 Driver

## Overview
The FiberZone_AFM L1 Driver provides CloudShell Resource Manager with the capability to communicate with switches that are part of the CloudShell inventory.
...
The FiberZone_AFM L1 Driver package includes:
| File name | Description |
| ------ | ------ |
| FIBERZONE_AFM.exe | Driver used by CloudShell Server |
| fiberzone_afm_runtime_configuration.json | JSON file enabling additional configuration interface for the driver
| FiberZone_AFMResourceConfiguration.xml | An XML file holding all attribute and capabilities of the L1 switches of the same vendor |
...
In step 7 at the above guide, you will need to copy only one exe file, and instead of the runtimeConfig.xml file please copy the fiberzone_afm_runtime_configuration.json file.
...
### Configuration
*add any relevant information about the different keys in the fiberzone_afm_runtime_configuration.json file or remove this section*
| Feature | Description |
| ------ | ------ |
